...
- `tests/api-v1-permission-coverage.test.ts` – API v1 explicit permission check guardrails.
- `tests/api-v1-hardening-coverage.test.ts` – API v1 rate-limit and auth-error mapping guardrails.
- `tests/api-v1-response-envelope-coverage.test.ts` – API v1 response envelope (`ok`, version, server time) guardrails.
- `tests/api-v1-error-contract-coverage.test.ts` – API v1 structured error response contract guardrails.
...
- `tests/download-route-no-store-coverage.test.ts` – PDF/export download no-store header guardrails.
