...
import { API_V1_VERSION, type ApiV1LabSummaryResponse } from "@/lib/api/v1"
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    if (error) {
      return apiError(500, "lab_summary_failed", "Failed to load lab summary", request)
    }
    ...
    const payload: ApiV1LabSummaryResponse = {
      ok: true,
