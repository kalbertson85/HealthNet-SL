...
import { API_V1_VERSION, type ApiV1RecordsSummaryResponse } from "@/lib/api/v1"
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    if (error) {
      return apiError(500, "records_summary_failed", "Failed to load records summary", request)
    }
    ...
    const payload: ApiV1RecordsSummaryResponse = {
      ok: true,
