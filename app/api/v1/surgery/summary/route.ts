...
import { API_V1_VERSION, type ApiV1SurgerySummaryResponse } from "@/lib/api/v1"
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    if (error) {
      return apiError(500, "surgery_summary_failed", "Failed to load surgery summary", request)
    }
    ...
    const payload: ApiV1SurgerySummaryResponse = {
      ok: true,
