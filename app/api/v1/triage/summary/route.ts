...
import { API_V1_VERSION, type ApiV1TriageSummaryResponse } from "@/lib/api/v1"
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    if (error) {
      return apiError(500, "triage_summary_failed", "Failed to load triage summary", request)
    }
    ...
    const payload: ApiV1TriageSummaryResponse = {
      ok: true,
